...
<html>
    ...
    <body>
        <?php if (isset($item)) { ?>
    	    ...
    	    <?php } ?>
	    <?php } else { ?>
	        <div style="float:left"><h1>Edición del producto - Nuevo producto</h1></div>
        ...
        <form method="post">
            ...
            <table boder="0" width="50%">
                ...
                <?php if (showValue($item->specialShipping) || !isset($item)) { ?><tr><td>Coste de envío especial:</td><td><input name="item_specialShippingCost" type="text" value="<?php echo $item->specialShippingCost ?>"/></td></tr><?php } ?>
