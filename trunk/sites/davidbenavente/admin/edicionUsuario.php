...
<html>
    ...
    <body>
        <div style="float:left"><h1><?= sprintf(_("Edición del Usuario %s"), $user->id." - ".$user->email) ?></h1></div>
        ...
        <table>
			...
			<tr><td><?= _("Envío de mail") ?></td><td><input type="checkbox" name="user_mailing" value="1" <?php echo $user->mailing?"checked":"" ?>></td></tr>
		</table>	
        ...
        <center>
        	<table style="float:left; margin-left: 15%">
        	    ...
        	    <tbody>
    				...
    				<tr><td align="left"><?= _("Dirección") ?></td><td><input type="text" name="user_billingData_address" value="<?php echo $user->billingData['address'] ?>"/></td></tr>
    				...
    				<tr><td align="left"><?= _("Código Postal") ?></td><td><input type="text" name="user_billingData_postalCode" value="<?php echo $user->billingData['postalCode'] ?>"/></td></tr>
			...
			<table style="float:right; margin-right: 15%">
        	    ...
        	    <tbody>
    				...
    				<tr><td align="left"><?= _("Dirección") ?></td><td><input type="text" name="user_shippingData_address" value="<?php echo $user->shippingData['address'] ?>"/></td></tr>
    				...
    				<tr><td align="left"><?= _("Código Postal") ?></td><td><input type="text" name="user_shippingData_postalCode" value="<?php echo $user->shippingData['postalCode'] ?>"/></td></tr>
